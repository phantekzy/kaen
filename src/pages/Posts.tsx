        ...
        <div className="min-h-screen bg-black relative w-full">
            ...
            <div className="relative z-10 max-w-7xl mx-auto pt-24 pb-32 px-6">
                <header className="mb-16 border-b border-white/5 pb-10">
                    ...
                    <h1 className="mt-6 text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-white tracking-tighter mb-6 uppercase">
                        Recent <span className="text-pink-600">Posts</span>
                    </h1>

                    <p className="max-w-2xl text-xs sm:text-sm md:text-base text-zinc-500 leading-relaxed font-medium uppercase tracking-tight">
