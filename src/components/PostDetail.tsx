              ...
              {!isDeleting ? (
                ...
                >
                  <button
                    ...
                    className="p-2 bg-black/50 hover:bg-white hover:text-black rounded-lg transition-all border border-white/10"
                  >
                    <Edit3 size={14} />
                  </button>
                  <button
                    onClick={() => setIsDeleting(true)}
                    className="p-2 bg-black/50 hover:bg-red-600 rounded-lg transition-all border border-white/10"
                  >
                    <Trash2 size={14} />
                  </button>
                </motion.div>
                ...
                >
                  ...
                  <button
                    ...
                    className="p-1.5 bg-black/20 text-white rounded hover:bg-black transition-all"
                  >
                    <X size={12} />
                  </button>
                </motion.div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  className="bg-white text-black px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-pink-600 hover:text-white transition-all"
                >
                  Save Post
                </button>
                <button
                  onClick={() => setIsEditing(false)}
                  className="bg-zinc-800 text-zinc-400 px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest hover:text-white transition-all"
                >
                  Cancel
                </button>
              </div>
