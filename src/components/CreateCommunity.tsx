...
const createCommunity = async (community: CommunityInput) => {
    // .select().single() ensures we get the data back to confirm success
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="space-y-0">
                                <h2 className="text-[clamp(2.5rem,8vw,5rem)] font-black text-white tracking-tighter leading-[0.8] uppercase italic">
                                    FOUND YOUR
                                </h2>
                                <h2 className="text-pink-600 text-[clamp(2.5rem,8vw,5rem)] font-black tracking-tighter leading-[0.8] uppercase italic">
                                    NETWORK
                                </h2>
                                <p className="mt-4 text-zinc-500 text-[9px] font-bold uppercase tracking-[0.4em]">
                                    Protocol initialized on the network
                                </p>
                            </div>
                            ...
                            <div className="flex gap-4 pt-4">
                                <button
                                    ...
                                    className="flex-1 h-14 bg-white text-black font-black uppercase text-[10px] tracking-widest rounded-xl hover:bg-pink-600 hover:text-white transition-all shadow-xl"
                                >
                                    Communities List
                                </button>
                                <button
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-white/5">
                            ...
                            <button
                                ...
                                ${isPending || !user
                                        ...
                                        : "bg-white text-black hover:bg-pink-600 hover:text-white shadow-lg active:scale-95"
                                    }`}
                            >
                                {isPending ? (
                                    ...
                                    <>
                                        Initialize Community <ArrowRight size={14} />
                                    </>
                                )}
                            </button>
                        </div>
