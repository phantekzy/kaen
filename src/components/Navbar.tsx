            ...
            >
                <div className="w-full max-w-[1440px] flex items-center justify-between bg-[#1a1a1b]/80 backdrop-blur-xl border border-[#343536] h-14 rounded-2xl px-5 shadow-2xl">
                        ...
                        {navLinks.map(({ name, link, icon }) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span
                                        className={`relative z-10 text-[12px] font-bold tracking-tight transition-colors ${isActive
                                            ? "text-white"
                                            : "text-[#818384] group-hover:text-white"
                                            }`}
                                    >
                    ...
                    <div className="flex items-center gap-4">
                        <div
                            className={`flex items-center bg-black/40 border transition-all duration-300 rounded-xl px-3 h-9 ${isSearchFocused
            ...
            <div className="md:hidden fixed bottom-6 inset-x-4 z-50">
                <div className="bg-[#1a1a1b]/95 backdrop-blur-2xl border border-[#343536] h-16 rounded-[20px] flex items-center justify-around px-2 shadow-2xl">
                    {navLinks.map(({ name, link, icon }) => {
                        ...
                        return (
                            <Link
                                key={name}
                                to={link}
                                className={`flex flex-col items-center gap-1 p-2 rounded-xl transition-all ${isActive ? "text-pink-500" : "text-[#818384]"
                                    }`}
                            >
                                {icon}
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 p-2 transition-colors ${menuOpen ? "text-pink-500" : "text-[#818384]"
                            }`}
                    >
                        <Menu size={18} />
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 gap-2">
                                ...
                                >
                                    <div
                                        className={`p-2 rounded-lg ${user ? "bg-red-500/20" : "bg-blue-500/20"
                                            }`}
                                    >
                                        {user ? (
