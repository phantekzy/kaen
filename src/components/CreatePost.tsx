                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="p-6 md:p-10 space-y-6">
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                required
                                className="w-full bg-white/5 border border-white/10 p-4 text-xl font-bold text-white outline-none rounded-xl focus:border-pink-600 transition-all placeholder:text-zinc-600"
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative group">
                                ...
                                >
                                    <option value="" className="bg-zinc-900 text-zinc-500">-- Choose Destination Network --</option>
